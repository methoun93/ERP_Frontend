...
import { AreaInformationForm, AreaInformationRow } from './area-information.models';

export const AREA_INFORMATION_PAGE: ErpPageDefinition<AreaInformationForm, AreaInformationRow> & { idKey?: string } = {
    ...
    sections: [
      {
        ...
        columns: 2,
        fields: [
          { key: 'compId', label: 'Company', type: 'searchSelect', required: true, validators: [Validators.required], lookupApi: '/adm-company-infos', optionValueKey: 'compId', optionLabelKey: 'compName' },
