...
export const MERCHENDISING_SETUP_PAGES: (ErpPageDefinition & { idKey?: string })[] = [
  ...
  page({
    ...
    fields: [
      ...
      lookup('countryId', 'Country', '/administration/lookups/countries', 'countryId', 'countryName'),
      lookup('buyerAgentId', 'Buyer Agent', '/administration/lookups/buyer-agents', 'buyerAgentId', 'agentName'),
      lookup('buyerBrandId', 'Buyer Brand', '/administration/lookups/buyer-brands', 'buyerBrandId', 'brandName'),
      text('contactPerson', 'Contact Person'),
      email('email')
    ],
